...
import com.example.jugaad_app.Model.Cart;
import com.example.jugaad_app.Prevalent.Prevalent;
import com.example.jugaad_app.ViewHolder.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter = new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder cartViewHolder, int i, @NonNull Cart cart) {
                ...
                cartViewHolder.txtProductName.setText(cart.getProd_name());
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    if (shippingState.equals("shipped")){
                        ...
                        txtMsg1.setText("Your final order has been Shipped successfully. Soon you will receive your order.");
