...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userPhoneEditText = (EditText) findViewById(R.id.settings_phone_numer);
        addressEditText = (EditText) findViewById(R.id.settings_address);
        profileChangeTextBtn = (TextView) findViewById(R.id.profile_image_change_btn);
        closeTextBtn = (TextView) findViewById(R.id.close_settings_btn);
        saveTextBtn = (TextView) findViewById(R.id.update_settings_btn);
        securityQuestionsBtn = findViewById(R.id.securityquestions_btn);
    ...
    private void uploadImage() {
        ...
        progressDialog.setTitle("UpdateProfile");
